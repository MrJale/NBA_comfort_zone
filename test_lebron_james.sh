...
/usr/local/spark/bin/spark-submit --class NBA_kmeans --master=spark://$SPARK_MASTER:7077 target/KMeans-1.0-SNAPSHOT.jar hdfs://$SPARK_MASTER:9000/kmeans/input/ "lebron james"
mvn clean
